...
public class Imposto {
	public static void main (String args[]) {
		/* Desenvolva uma aplicação em Java de Impostos a pagar:
		 * 
...
0 - Sair.
		...
		ArrayList<Vendas> multas = new ArrayList<>();
		Vendas v = new Vendas();
		String menu = "--- MENU ---\n"
				+ "Opção 1: Cadastro de vendas\n"
				+ "Opção 2: Consulta de impostos a pagar no mes\n"
				+ "Opção 0: Sair";
		int option=0;
		do {
			...
			case 1:
				...
				System.out.println("Registre sua venda: ");
				v.setVendasMes(sc.nextDouble());
				sc.reset();
				multas.add(v);
				break;
			
			case 2:
				System.out.println("Consulta de impostos a pagar no mes: ");
				v.passouLimiteMes();
				break;
